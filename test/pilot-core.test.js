...
import { applyMark, csvCell, filterVoters, normalizeVoterCsv, parseCsv } from '../docs/pilot-core.js';

test('search finds names and IDs without a page reload', () => {
  const voters = [
    { id: '1', first_name: 'Ada', last_name: 'Sample', external_id: 'DEMO-001' },
    { id: '2', first_name: 'Ben', last_name: 'Practice', external_id: 'DEMO-002' },
  ];
